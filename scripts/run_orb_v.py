...
def main():
    ...
    cfg = BacktestConfig(
        symbol="PVC2609", contract="V2609", period="5m",
        start_date="2026-03-01", end_date="2026-06-03",
        strategy="orb", strategy_params={},
        initial_capital=50000.0, tick_size=1, tick_value=5,
        margin_rate=0.09, fee_per_lot=2, slippage_ticks=1,
